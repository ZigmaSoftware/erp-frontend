...
export default function TransportMediumCreationList() {
  ...
  const ENC_NEW_PATH = `/${encSalesService}/${encTransportMediumCreation}/new`;
  const ENC_EDIT_PATH = (unique_id: string) =>
    `/${encSalesService}/${encTransportMediumCreation}/${unique_id}/edit`;

  const fetchTransportMediums = async () => {
    try {
      const res = (await transportMediumCreationServiceApi.list()) as TransportMediumCreation[];
  ...
  const handleDelete = async (unique_id: string) => {
    ...
    await transportMediumCreationServiceApi.remove(unique_id);
  ...
  const statusTemplate = (row: TransportMediumCreation) => {
    const updateStatus = async (value: boolean) => {
      await transportMediumCreationServiceApi.update(row.unique_id, {
