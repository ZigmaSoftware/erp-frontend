...
import { targetEntryServiceApi } from "@/helpers/admin";
import type { TargetEntry } from "../types/salesService.types";
...
export default function TargetEntryList() {
  ...
  const ENC_NEW_PATH = `/${encSalesService}/${encTargetEntry}/new`;
  const ENC_EDIT_PATH = (unique_id: string) =>
    `/${encSalesService}/${encTargetEntry}/${unique_id}/edit`;
  ...
  const handleDelete = async (unique_id: string) => {
    ...
    await targetEntryServiceApi.remove(unique_id);
