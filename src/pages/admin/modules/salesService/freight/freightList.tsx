...
export default function FreightList() {
  ...
  const ENC_NEW_PATH = `/${encSalesService}/${encFreight}/new`;
  const ENC_EDIT_PATH = (unique_id: string) =>
    `/${encSalesService}/${encFreight}/${unique_id}/edit`;
  ...
  const handleDelete = async (unique_id: string) => {
    const confirmDelete = await Swal.fire({
      title: "Are you sure?",
      text: "This freight record will be permanently deleted!",
      icon: "warning",
    ...
    await freightApi.remove(unique_id);
    ...
    <div className="px-3 py-3 w-full">
      ...
      >
        ...
        <Column
          ...
          body={(row: Freight) => statusLabel(row.freight_status)}
          style={{ width: "140px" }}
        />
