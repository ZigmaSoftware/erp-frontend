...
export default function RdfInertsPercEntryList() {
  ...
  const ENC_NEW_PATH = `/${encSalesMasters}/${encRdfInertsPercEntry}/new`;
  const ENC_EDIT_PATH = (unique_id: string) =>
    `/${encSalesMasters}/${encRdfInertsPercEntry}/${unique_id}/edit`;

  const fetchEntries = async () => {
    setLoading(true);
    try {
      const res = (await rdfInertsPercEntryApi.list()) as RdfInertsPercEntry[];
      setEntries(res);
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (uniqueId: string) => {
    ...
    await rdfInertsPercEntryApi.remove(uniqueId);
