...
export default function ItemCreationForm() {
  ...
  const ENC_LIST_PATH = `/${encSalesMasters}/${encItemCreation}`;
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      setFetching(true);
      try {
        const res = await itemCreationApi.get(id as string);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (isEdit) {
        await itemCreationApi.update(id as string, payload);
        Swal.fire({
          icon: "success",
        ...
        await itemCreationApi.create(payload);
        Swal.fire({
          icon: "success",
