...
export default function CustomerCreationList() {
  ...
  const { encSalesMasters, encCustomerCreation } = getEncryptedRoute();

  const ENC_NEW_PATH = `/${encSalesMasters}/${encCustomerCreation}/new`;
  const ENC_EDIT_PATH = (unique_id: string) =>
    `/${encSalesMasters}/${encCustomerCreation}/${unique_id}/edit`;
  ...
  const handleDelete = async (unique_id: string) => {
    ...
    await customerCreationApi.remove(unique_id);
