...
import { subCategoryApi, itemTypeApi } from "@/helpers/admin";
import { getEncryptedRoute } from "@/utils/routeCache";
import { extractErrorMessage } from "@/utils/errorUtils";
import { normalizeRelationId } from "@/utils/formHelpers";
import type { SubCategory, ItemType } from "../types/salesMasters.types";
...
export default function SubCategoryForm() {
  ...
  const ENC_LIST_PATH = `/${encSalesMasters}/${encSubCategory}`;
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      setFetching(true);
      try {
        const res = await subCategoryApi.get(id as string);
